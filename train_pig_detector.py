...
print("\n--- Next Steps ---")
print("1. Review the plots to check for overfitting (training accuracy much higher than validation accuracy).")
print("2. Increase EPOCHS if the model is still learning.")
print("3. Unfreeze some layers of the base_model and fine-tune with a very low learning rate for better performance.")
print("4. Explore more advanced data augmentation techniques.")
print("5. Consider different pre-trained models (e.g., EfficientNetB0, ResNet50).")
